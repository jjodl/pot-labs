...
Create a new workspace for the work in this lab guide. This is showing PoTWorkSpace on your local windows box.   If you have Linux then will use **/home/PoTWorkSpace**
...
## 2.3.1 Import PNG_Basic <a name="import_ping_basic"></a>
...
## 2.3.3 Deploy PING_Basic <a name="deploy_ping_basic"></a>
...
<span style="color:orange">***IMAGE MISSING***</span>
...
[http://localhost:7600/PING_Basic](http://localhost:7600/PING_Basic)
...
3\. When prompted to use the username and password provided to you for this lab. 
...
5\. You can also go to the upper left cornor and click on the hambugar tab and will see the list of capabilities.  In the upper right cornor click on the icon to see who you are logged in as.

![alt text][pic37]

6\. Select the **App Connect Dashboard**:

![alt text][pic38]

7\. This will take you to the IBM App Connect Home page.  Select the ***Create a server tile***
...
12\. This will take you to the Servers page.   You will see the integration server we just created and it will show Unavailable to the containers are started. 
After a little bit in the upper right hand corner click on refresh.  Once the server is up and running it will show as <span style="color: green">**Started**</span> 
...
[http://is-toolkit-basic-http-cody9.apps.cody.coc-ibm.com/PING_Basic](http://is-toolkit-basic-http-cody9.apps.cody.coc-ibm.com/PING_Basic)
